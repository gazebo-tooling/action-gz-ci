...
SOURCE_DEPENDENCIES="`pwd`/.github/$INPUT_DOCKER_IMAGE/dependencies.yaml"
SCRIPT_BEFORE_CMAKE="`pwd`/.github/$INPUT_DOCKER_IMAGE/before_cmake.sh"
SCRIPT_BETWEEN_CMAKE_MAKE="`pwd`/.github/$INPUT_DOCKER_IMAGE/between_cmake_make.sh"
SCRIPT_AFTER_MAKE="`pwd`/.github/$INPUT_DOCKER_IMAGE/after_make.sh"
SCRIPT_AFTER_MAKE_TEST="`pwd`/.github/$INPUT_DOCKER_IMAGE/after_make_test.sh"
...
if [ -f "$SOURCE_DEPENDENCIES" ] ; then
  mkdir -p deps/src
  cd deps
  vcs import src < ../.github/$INPUT_DOCKER_IMAGE/dependencies.yaml
